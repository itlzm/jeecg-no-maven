...
public class TestController extends BaseController {
	...
	public ModelAndView list(HttpServletRequest request) {
		return new ModelAndView("com/jeecg/demo/testList");
	}
	...
	public ModelAndView goAdd(TestEntity test, HttpServletRequest req) {
		...
		return new ModelAndView("com/jeecg/demo/test-add");
	}
	/**
	 * 测试编辑页面跳转
	 * 
	...
	public ModelAndView goUpdate(TestEntity test, HttpServletRequest req) {
		...
		return new ModelAndView("com/jeecg/demo/test-update");
	}
	...
	public String exportXls(TestEntity test,HttpServletRequest request,HttpServletResponse response
		...
		modelMap.put(NormalExcelConstants.PARAMS,new ExportParams("测试列表", "导出人:"+ResourceUtil.getSessionUser().getRealName(),
			"导出信息"));
