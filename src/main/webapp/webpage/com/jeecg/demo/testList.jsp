...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="testList" checkbox="false" pagination="true" fitColumns="true" title="测试" actionUrl="testController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgDelOpt title="删除" url="testController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
 ...
 <script src = "webpage/com/jeecg/demo/testList.js"></script>		
